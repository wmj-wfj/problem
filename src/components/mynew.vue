      ...
      <header class="pull-refresh">
        <slot name="pull-refresh">
          ...
          <div class="up-tip" v-if="dropDownState==2">
            <img v-if="dropDownInfo.upImg" class="up-img" :src="require('@/assets/'+dropDownInfo.upImg)">
            <span class="up-text">{{dropDownInfo.upText}}</span>
          </div>
          <div class="refresh-tip" v-if="dropDownState==3">
            <img v-if="dropDownInfo.refreshImg" class="refresh-img" :src="require('@/assets/'+dropDownInfo.refreshImg)">
